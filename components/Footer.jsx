            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p id="about" className="max-w-[410px] mt-6 text-sm">Welcome to Jkart, your ultimate destination for the latest and smartest gadgets. From smartphones and smartwatches to essential accessories, we bring you the best in innovation — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2026 © JARP All Right Reserved.
                </p>
            </div>
        </footer>
    );
